...
import { TvShowsListFiltersFormValues } from '@/components/tv-shows-list-filters'

export const AirDateField = () => {
  const { dictionary, language } = useLanguage()
  const { control, watch } = useFormContext<TvShowsListFiltersFormValues>()

  const startDate = watch('air_date.gte')
  const endDate = watch('air_date.lte')
