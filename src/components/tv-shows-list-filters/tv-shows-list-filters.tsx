...
import {
  ...
  getDefaultValues,
} from './tv-shows-list-filters.utils'
import {
  Drawer,
  DrawerClose,
  DrawerContent,
...
export const TvShowsListFilters = () => {
  ...
  const methods = useForm<TvShowsListFiltersFormValues>({
    defaultValues: {
  ...
  const onSubmit = (values: TvShowsListFiltersFormValues) => {
