...
export const UserBanner = ({ user }: UserBannerProps) => {
  ...
  if (mode === 'EDIT') {
    return (
      ...
      >
        <ImagePicker.Trigger>
          <section className="group relative flex w-full cursor-pointer items-center justify-center overflow-hidden rounded-none aspect-banner lg:rounded-lg border-b lg:border">
            {bannerUrl && (
