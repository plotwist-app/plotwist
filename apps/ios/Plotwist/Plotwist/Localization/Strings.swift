...
enum L10n {
  ...
  private static let strings: [Language: Strings] = [
    .enUS: Strings(
      ...
      claimBadge: "Claim",
      achSectionInProgress: "In Progress",
      achSectionSagas: "Sagas",
      achSectionLocked: "Locked",
      achSectionClaimed: "Claimed",
      achOfTotal: "of",
      achReadyToClaim: "ready to claim",
      achBadgesClaimed: "badges claimed",
      achFirstSteps: "The journey begins",
      achFirstStepsDesc: "Add your first item to the collection",
      achHorrorFan: "Lights off",
      achHorrorFanDesc: "Watch 10 horror movies",
      achBingeWatcher: "Just one more episode",
      achBingeWatcherDesc: "Finish 5 complete series",
      achExplorer: "A bit of everything",
      achExplorerDesc: "Watch titles from 10 different genres",
      achCritic: "Everyone's a critic",
      achCriticDesc: "Write 10 reviews",
      achMarathon: "Triple feature",
      achMarathonDesc: "Watch 3 movies in a single day",
      achCinephile: "A life in film",
      achCinephileDesc: "Watch 100 movies",
      achSocialButterfly: "The more the merrier",
      achSocialButterflyDesc: "Follow 10 people",
      achWatchlistPro: "So much to watch",
    ...
    .ptBR: Strings(
      ...
      claimBadge: "Resgatar",
      achSectionInProgress: "Em Progresso",
      achSectionSagas: "Sagas",
      achSectionLocked: "Bloqueadas",
      achSectionClaimed: "Conquistadas",
      achOfTotal: "de",
      achReadyToClaim: "prontas para resgatar",
      achBadgesClaimed: "distintivos conquistados",
      achFirstSteps: "A jornada começa",
      achFirstStepsDesc: "Adicione seu primeiro item à coleção",
      achHorrorFan: "Apaga a luz",
      achHorrorFanDesc: "Assista 10 filmes de terror",
      achBingeWatcher: "Só mais um episódio",
      achBingeWatcherDesc: "Termine 5 séries completas",
      achExplorer: "Um pouco de tudo",
      achExplorerDesc: "Assista títulos de 10 gêneros diferentes",
      achCritic: "Todo mundo é crítico",
      achCriticDesc: "Escreva 10 reviews",
      achMarathon: "Sessão tripla",
      achMarathonDesc: "Assista 3 filmes em um único dia",
      achCinephile: "Vida de cinema",
      achCinephileDesc: "Assista 100 filmes",
      achSocialButterfly: "Quanto mais, melhor",
      achSocialButterflyDesc: "Siga 10 pessoas",
      achWatchlistPro: "Tanto pra assistir",
    ...
    .esES: Strings(
      ...
      claimBadge: "Reclamar",
      achSectionInProgress: "En Progreso",
      achSectionSagas: "Sagas",
      achSectionLocked: "Bloqueadas",
      achSectionClaimed: "Conseguidas",
      achOfTotal: "de",
      achReadyToClaim: "listas para reclamar",
      achBadgesClaimed: "insignias conseguidas",
      achFirstSteps: "El viaje comienza",
      achFirstStepsDesc: "Añade tu primer título a la colección",
      achHorrorFan: "Luces apagadas",
      achHorrorFanDesc: "Ve 10 películas de terror",
      achBingeWatcher: "Solo un episodio más",
      achBingeWatcherDesc: "Termina 5 series completas",
      achExplorer: "Un poco de todo",
      achExplorerDesc: "Ve títulos de 10 géneros diferentes",
      achCritic: "Todos somos críticos",
      achCriticDesc: "Escribe 10 reseñas",
      achMarathon: "Sesión triple",
      achMarathonDesc: "Ve 3 películas en un solo día",
      achCinephile: "Vida de cine",
      achCinephileDesc: "Ve 100 películas",
      achSocialButterfly: "Cuantos más, mejor",
      achSocialButterflyDesc: "Sigue a 10 personas",
      achWatchlistPro: "Tanto por ver",
    ...
    .frFR: Strings(
      ...
      claimBadge: "Récupérer",
      achSectionInProgress: "En Cours",
      achSectionSagas: "Sagas",
      achSectionLocked: "Verrouillés",
      achSectionClaimed: "Obtenus",
      achOfTotal: "sur",
      achReadyToClaim: "prêts à récupérer",
      achBadgesClaimed: "badges obtenus",
      achFirstSteps: "Le voyage commence",
      achFirstStepsDesc: "Ajoutez votre premier titre à la collection",
      achHorrorFan: "Lumières éteintes",
      achHorrorFanDesc: "Regardez 10 films d'horreur",
      achBingeWatcher: "Encore un épisode",
      achBingeWatcherDesc: "Terminez 5 séries complètes",
      achExplorer: "Un peu de tout",
      achExplorerDesc: "Regardez des titres de 10 genres différents",
      achCritic: "Tout le monde est critique",
      achCriticDesc: "Rédigez 10 critiques",
      achMarathon: "Séance triple",
      achMarathonDesc: "Regardez 3 films en une seule journée",
      achCinephile: "Une vie de cinéma",
      achCinephileDesc: "Regardez 100 films",
      achSocialButterfly: "Plus on est de fous",
      achSocialButterflyDesc: "Suivez 10 personnes",
      achWatchlistPro: "Tant de choses à voir",
    ...
    .deDE: Strings(
      ...
      claimBadge: "Einlösen",
      achSectionInProgress: "In Bearbeitung",
      achSectionSagas: "Sagas",
      achSectionLocked: "Gesperrt",
      achSectionClaimed: "Erhalten",
      achOfTotal: "von",
      achReadyToClaim: "bereit zum Einlösen",
      achBadgesClaimed: "Abzeichen erhalten",
      achFirstSteps: "Die Reise beginnt",
      achFirstStepsDesc: "Füge dein erstes Element zur Sammlung hinzu",
      achHorrorFan: "Licht aus",
      achHorrorFanDesc: "Schau 10 Horrorfilme",
      achBingeWatcher: "Nur noch eine Folge",
      achBingeWatcherDesc: "Beende 5 komplette Serien",
      achExplorer: "Von allem etwas",
      achExplorerDesc: "Schau Titel aus 10 verschiedenen Genres",
      achCritic: "Jeder ist ein Kritiker",
      achCriticDesc: "Schreibe 10 Bewertungen",
      achMarathon: "Triple Feature",
      achMarathonDesc: "Schau 3 Filme an einem Tag",
      achCinephile: "Ein Leben für Film",
      achCinephileDesc: "Schau 100 Filme",
      achSocialButterfly: "Je mehr, desto besser",
      achSocialButterflyDesc: "Folge 10 Personen",
      achWatchlistPro: "So viel zu sehen",
    ...
    .itIT: Strings(
      ...
      claimBadge: "Riscatta",
      achSectionInProgress: "In Corso",
      achSectionSagas: "Saghe",
      achSectionLocked: "Bloccati",
      achSectionClaimed: "Ottenuti",
      achOfTotal: "di",
      achReadyToClaim: "pronti da riscattare",
      achBadgesClaimed: "distintivi ottenuti",
      achFirstSteps: "Il viaggio inizia",
      achFirstStepsDesc: "Aggiungi il tuo primo titolo alla collezione",
      achHorrorFan: "Luci spente",
      achHorrorFanDesc: "Guarda 10 film horror",
      achBingeWatcher: "Solo un altro episodio",
      achBingeWatcherDesc: "Finisci 5 serie complete",
      achExplorer: "Un po' di tutto",
      achExplorerDesc: "Guarda titoli di 10 generi diversi",
      achCritic: "Tutti sono critici",
      achCriticDesc: "Scrivi 10 recensioni",
      achMarathon: "Sessione tripla",
      achMarathonDesc: "Guarda 3 film in un solo giorno",
      achCinephile: "Una vita di cinema",
      achCinephileDesc: "Guarda 100 film",
      achSocialButterfly: "Più siamo, meglio è",
      achSocialButterflyDesc: "Segui 10 persone",
      achWatchlistPro: "Tanto da vedere",
    ...
    .jaJP: Strings(
      ...
      claimBadge: "獲得",
      achSectionInProgress: "進行中",
      achSectionSagas: "サーガ",
      achSectionLocked: "未解放",
      achSectionClaimed: "獲得済み",
      achOfTotal: "/",
      achReadyToClaim: "獲得可能",
      achBadgesClaimed: "バッジ獲得済み",
      achFirstSteps: "旅の始まり",
      achFirstStepsDesc: "最初のアイテムをコレクションに追加",
      achHorrorFan: "電気を消して",
      achHorrorFanDesc: "ホラー映画を10本鑑賞",
      achBingeWatcher: "あと1話だけ",
      achBingeWatcherDesc: "シリーズを5作品完走",
      achExplorer: "なんでも少しずつ",
      ...
      achSocialButterfly: "仲間は多いほどいい",
      achSocialButterflyDesc: "10人をフォロー",
      achWatchlistPro: "観たいものだらけ",
...
struct Strings {
  ...
  let achSectionInProgress: String
  let achSectionSagas: String
  let achSectionLocked: String
  let achSectionClaimed: String
  let achOfTotal: String
  let achReadyToClaim: String
  let achBadgesClaimed: String
