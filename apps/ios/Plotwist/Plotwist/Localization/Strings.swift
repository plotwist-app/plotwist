...
enum L10n {
  ...
  private static let strings: [Language: Strings] = [
    .enUS: Strings(
      ...
      onboardingDiscoverSubtitle: "Right to save, left to skip, up if you've already watched",
    ...
    .ptBR: Strings(
      ...
      onboardingDiscoverSubtitle: "Direita para salvar, esquerda para pular, cima se já assistiu",
    ...
    .esES: Strings(
      ...
      onboardingDiscoverSubtitle: "Derecha para guardar, izquierda para pasar, arriba si ya lo viste",
    ...
    .frFR: Strings(
      ...
      onboardingDiscoverSubtitle: "Droite pour sauver, gauche pour passer, haut si déjà vu",
    ...
    .deDE: Strings(
      ...
      onboardingDiscoverTitle: "Wische, um deine\nWatchlist aufzubauen 🍿",
      onboardingDiscoverSubtitle: "Rechts zum Speichern, links zum Überspringen, hoch wenn schon gesehen",
    ...
    .itIT: Strings(
      ...
      onboardingDiscoverSubtitle: "Destra per salvare, sinistra per saltare, su se l'hai già visto",
    ...
    .jaJP: Strings(
      ...
      onboardingDiscoverSubtitle: "右で保存、左でスキップ、上は視聴済み",
